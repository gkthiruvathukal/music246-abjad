"""CLI for building Algo Rhythms Quartet No. 1."""
...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description="Generate Algo Rhythms Quartet No. 1 from TOML config.",
    )
    parser.add_argument(
        "-c",
        "--config",
        default="configs/algorithmic-piano-quartet-no1.toml",
        help="path to TOML config (default: configs/algorithmic-piano-quartet-no1.toml)",
    )
    parser.add_argument(
        "-o",
        "--output-dir",
