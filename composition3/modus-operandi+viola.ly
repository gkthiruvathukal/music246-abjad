...
\header {
  title = "Modus Operandi for Piano and Option for Viola"
...
leftHandA = \relative c {
  ...
  f,2( ees') | c2( f,) |
  bes2( f) | c'2( ees,) | \break

  f2( c') | bes2( f') |
  c2( bes) | f2( c'\>) \p \bar "||" \pageBreak
}
...
leftHandB = \relative c {
  ...
  \p f,4.( c') | ges4. r |
  \mf f4.( des') | ges,4.( c) | \break

  f,4.( ees') | des4.( ges,) |
  \mp c4.( f,) | \mf c'4. r \bar "||" \pageBreak
}
